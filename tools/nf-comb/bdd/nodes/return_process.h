...
public:
  ...
  ReturnProcess(node_id_t _id, int _value, Operation _operation, uint64_t _from_id)
      : Node(_id, Node::NodeType::RETURN_PROCESS, _from_id), value(_value), operation(_operation) {}

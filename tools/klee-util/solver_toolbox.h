...
struct solver_toolbox_t {
  ...
  bool isEqual(klee::ref<klee::Expr> len1, klee::ref<klee::Expr> len2, klee::ConstraintManager c);
  bool isGreaterthan(klee::ref<klee::Expr> len1, klee::ref<klee::Expr> len2, klee::ConstraintManager c);
};

...
bool solver_toolbox_t::is_expr_maybe_true(klee::ref<klee::Expr> expr) const {
  klee::ConstraintManager no_constraints;
  return is_expr_maybe_true(no_constraints, expr);
}
...
bool solver_toolbox_t::is_expr_maybe_true(
  ...
  return is_expr_maybe_true(replaced_constraints, expr);
}

bool solver_toolbox_t::is_expr_maybe_false(klee::ref<klee::Expr> expr) const {
  klee::ConstraintManager no_constraints;
  return is_expr_maybe_false(no_constraints, expr);
}
...
bool solver_toolbox_t::is_expr_maybe_false(
  ...
  return is_expr_maybe_false(replaced_constraints, expr);
}
